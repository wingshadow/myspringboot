...
(function (factory) {
    ...
    $.fn.initFileInput = function (options, fileuploaded) {
        var defaults = {
            required: false,
            showRemove: true,
            showUpload: true,
        ...
        this.each(function () {
            ...
            $fileInput.fileinput({
                ...
                uploadExtraData: opts.uploadExtraData,
                required: opts.required,
                msgFilerequired: opts.msgFilerequired,
                dropZoneTitle: opts.dropZoneTitle,
                ...
                browseOnZoneClick: opts.browseOnZoneClick,
                dropZoneEnabled: opts.dropZoneEnabled,
                showCaption: opts.showCaption,
                allowedPreviewTypes: opts.allowedPreviewTypes,
