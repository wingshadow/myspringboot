package com.myland.framework.utils.code;

import com.myland.framework.utils.DateUtils;
...
import com.myland.framework.entity.ColumnEntity;
import com.myland.framework.entity.TableEntity;
	...
	public static String getFileName(String template, String className, String packageName){
		...
		if(template.contains("list.html.vm")){
			return "main" + File.separator + "resources" + File.separator + "static" + File.separator
					+ "admin" + File.separator + className.toLowerCase() + ".html";
		}
		
		if(template.contains("list.js.vm")){
			return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "public" + File.separator
					+ "js" + File.separator + "admin" + File.separator + className.toLowerCase() + ".js";
		}
