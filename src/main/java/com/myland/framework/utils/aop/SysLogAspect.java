package com.myland.framework.utils.aop;

import com.alibaba.fastjson.JSON;
import com.myland.framework.entity.SysLogEntity;
import com.myland.framework.service.SysLogService;
import com.myland.framework.utils.HttpContextUtils;
import com.myland.framework.utils.IPUtils;
...
public class SysLogAspect {
	...
	// @annotation 指定自定义注解
	@Pointcut("@annotation(com.myland.framework.utils.annotation.SysLog)")
