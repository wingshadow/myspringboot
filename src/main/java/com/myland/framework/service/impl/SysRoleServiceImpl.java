...
import com.myland.framework.dao.SysRoleDao;
import com.myland.framework.entity.SysRoleEntity;
import com.myland.framework.service.SysRoleMenuService;
import com.myland.framework.service.SysRoleService;
import com.myland.framework.service.SysUserRoleService;
import com.myland.framework.service.SysUserService;
import com.myland.framework.utils.Constant;
...
public class SysRoleServiceImpl implements SysRoleService {
	...
	@Override
	public PageInfo<SysRoleEntity> queryListForPage(Map<String, Object> map, int pageNum, int pageSize) {
		PageMethod.startPage(pageNum, pageSize);
		List<SysRoleEntity> lst = sysRoleDao.queryList(map);
