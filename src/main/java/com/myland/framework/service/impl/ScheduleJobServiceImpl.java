...
import com.myland.framework.dao.ScheduleJobDao;
import com.myland.framework.entity.ScheduleJobEntity;
import com.myland.framework.service.ScheduleJobService;
import com.myland.framework.utils.schedule.ScheduleUtils;
import com.myland.framework.utils.Constant.ScheduleStatus;
...
public class ScheduleJobServiceImpl implements ScheduleJobService {
	...
	@Override
	public PageInfo<ScheduleJobEntity> queryListForPage(Map<String, Object> map, int pageNum, int pageSize) {
		PageMethod.startPage(pageNum, pageSize);
		List<ScheduleJobEntity> lst = schedulerJobDao.queryList(map);
