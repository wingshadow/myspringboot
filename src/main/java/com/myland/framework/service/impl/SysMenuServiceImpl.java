...
import com.myland.framework.dao.SysMenuDao;
...
public class SysMenuServiceImpl implements SysMenuService {
	...
	@Override
	public PageInfo<SysMenuEntity> queryListForPage(Map<String, Object> map,int pageNum, int pageSize) {
		PageMethod.startPage(pageNum, pageSize);
		List<SysMenuEntity> lst = sysMenuDao.queryList(map);
